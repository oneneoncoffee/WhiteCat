...
String about_message = "<!DOCTYPE html>";
       ...
       about_message += "background: linear-gradient(90deg, rgba(2,0,36,1) 10%, rgba(1,1,85,1) 36%, rgba(0,212,255,1) 100%);";          
       about_message += "}";
       about_message += "h3 {"; 
       ...
       about_message += "<font color='red' size='30px'></br><h3>Johnny B Stroud</h3></br></center></font>";     
...
index3html += "<p>D1 Mini pro ESP8266 has enabled its SHT30 sensor.";
index3html += "";
index3html += "";
index3html += "</p>"; 
index3html += "<header>";
